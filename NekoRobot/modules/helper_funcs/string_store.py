GDNIGHT = [
    ...
    "`Hari ini adalah hari esok yang kita cemaskan kemarin. @sngtrhs`",
    "`Sama seperti kupu kupu terkejar tapi tidak tergapai. @Comiiinggg`",
    "`May be you need more worldwide friends, just join at @Mirc_Coffee_World`",
    "`The solution is, you have to make money yourself, learn here @mirc_forex`",
    "`broken heart? Enough to get acquainted with the handsomest policeman on Mirc, @inhumanedearth`",
    "`avoid being familiar and comfortable with @flyingbullets0. he has too many girls`",
    "`Watch this Policeman, @Bujanglapukmania, his seduction conquers hearts, his voice chat creates love, his private chat soothes, but his poison will kill you`",
    "`Dare to approach @Nitttpo, first, beat the amazon lion, fierce begging for mercy`",
    "`To play music: /Play + song title to listen to audio on the OS. /vplay + song title for video on OS. To listen alone without going through the OS: /Song + song title, then select audio or video, use /dashboard for your music settings.`",
    "`Join @mirc_trivia to play Trivia Game.`",
    "`You can follow our Instagram @mirc_grup or @mirc_coffee.`",
    "`Wanna see all meet up's group arround the world? add us on TikTok @mirc_grup.`",
